...
all : make_data make_suffle_data sample1_connect sample2_insert sample3_prepare sample4_append1 sample4_append2 make_data sample5_describe sample6_columns sample8_multi_session_multi_table
...
clean :
	rm -f *.o make_data make_suffle_data *.txt sample1_connect sample2_insert sample3_prepare sample4_append1 sample4_append2  sample5_describe sample6_columns sample8_multi_session_multi_table
